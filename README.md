...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/yassine-daoui-56a7ab1a0)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:daoui00yassine@gmail.com)
[![Portfolio](https://img.shields.io/badge/Portfolio-24292E?logo=githubpages&logoColor=white)](https://ydaoui.github.io/)
...
#### **Développeur & Système d'Information Sécurisé (Cybersécurité) - Exedos Tech**  
- **Durée :** Janvier 2026 - Présent  
- **Lieu :** France  
- **Compétences :** Python, Streamlit, HTML/CSS/JS, Azure, Hyper-V, Windows Server 2019, Linux Ubuntu, SAN, Cybersécurité, **Microsoft Intune (MDM, DAM)**  
- **Description :** Mise en place d'un outil en Streamlit (Python, HTML, CSS, JS) accessible en ligne sur une plateforme Azure pour la gestion d'un parc informatique. Création d'une plateforme de virtualisation Hyper-V pour les machines, gérée par Windows Server 2019, avec des machines Linux Ubuntu pour le stockage SAN et des PC Windows 11 pour les utilisateurs (11 machines virtuelles ouvertes sur 199 postes). **Administration des terminaux et des accès via Intune (MDM pour la gestion des appareils mobiles et DAM pour la gestion des actifs numériques).**  

#### **Responsable DATA - SOGEA Maroc (Vinci Construction)**  
- **Durée :** 24 Novembre 2025 - 30 Mai 2026 (CDD)  
- **Lieu :** Safi, Maroc (mission pour Jesa et OCP)  
- **Compétences :** Python, Tkinter, SQL Server, SQL Azure, Power BI, HSE, Gestion d'effectifs, Traçabilité  
- **Description :** Mission au sein de SOGEA Maroc (Vinci Construction) pour le compte de Jesa et OCP. Mise en place d'un outil centralisé en Tkinter (Python) pour l'analyse des Safety Observation Reports (HSE). Gestion des effectifs et du pointage, traçabilité des mouvements des engins via une application digitalisée avec base SQL Server et SQL Azure. Réalisation de rapports Power BI pour le suivi des différents KPI, collecte des données et analyse des besoins métier.
